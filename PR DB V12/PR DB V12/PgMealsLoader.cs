    ...
    public class PgMealsLoader
    {
        ...
        public BindingList<Meal> LoadMeals()
        {
            try
            {
                ...
                con.Open();
                //вот такой вот чудесный код будет +- во всех запросах к бд если создавать таблицы через интерфейс,
                //а не консоль т.к. при создании через интерфейс пгАдмин создает названия таблицы и всех ее колонок вот по такому шаблону  <"Название">.
                //(при создании таблицы названия вводятся по такому шаблону <Название>).
                //Т.е. при создании через интерфейс пгАдмин заключает все названия в кавычки,
                //а при создании через консоль этого не происходит.
